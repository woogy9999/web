				...
				<div class="col-12">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">seoul-list
								Page</li>
						</ol>
					</nav>
				</div>
							...
							<ul class="pagination">
								<c:if test="${startPage>1 }">
									<li class="page-item"><a class="page-link"
										href="../seoul/seoul_list.do?mode=${mode }&page=${startPage-1}">이전
								...
								<c:forEach var="i" begin="${startPage }" end="${endPage }">
									<li class="page-item ${i==curpage?'active':'' }"><a
										class="page-link"
										href="../seoul/seoul_list.do?mode=${mode }&page=${i}">${i }</a></li>
								</c:forEach>

								<c:if test="${endPage<totalpage }">
									<li class="page-item"><a class="page-link"
										href="../seoul/seoul_list.do?mode=${mode }&page=${endPage+1}">다음
