		...
		<main class="container clear">
			...
			<div class="content">
							...
							<li>
								<figure>
									<img class="radius-10 btmspace-10"
										src="https://www.menupan.com${image }"
				...
				<table class="table">
					...
					<tr>
						<td class="text-right"><a href="../food/list.do"
							class="btn btn-sm btn-success">좋아요</a> <a href="../food/list.do"
							class="btn btn-sm btn-info">찜하기</a> <a href="../food/list.do"
							class="btn btn-sm btn-danger">예약하기</a> <a href="../food/list.do"
							class="btn btn-sm btn-primary">목록</a></td>
					</tr>
				</table>
				<body>
					<div class="map_wrap">
